...
def generate_transactions(dest_file_prefix, num_transactions=25):  # Parameter for number of transactions
    ...
    filename = f"{dest_file_prefix}/transactions/transactions_{timestamp}.json"  # New line delimited JSON
